...
export function TabCard({
  ...
  return (
    <Card
      className={`overflow-hidden rounded-2xl border border-slate-200/70 dark:border-white/5 bg-white/90 dark:bg-card relative min-h-[22rem] ${onClick && !previewMode ? 'cursor-pointer hover:shadow-xl transition-shadow' : ''} ${className}`}
